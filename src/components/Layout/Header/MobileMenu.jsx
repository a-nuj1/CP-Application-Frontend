...
const MobileMenu = ({ isOpen, navItems, onClose }) => {
  ...
  return (
    <div 
      className="fixed inset-0 z-40 bg-black/60 backdrop-blur-lg overflow-y-auto" 
      style={{ top: "89px" }}
    >
      <div className="bg-gray-900/95 border-t border-cyan-500/20 w-full min-h-full pb-20">
        ...
        <div className="fixed bottom-0 left-0 right-0 px-6 py-4 border-t border-gray-700/50 bg-gray-900">
          <Link
            to="/login"
